...
h2o.saveModel(rf_1, path = "models/saved_models/randomForest_1")
h2o.saveModel(rf_3, path = "models/saved_models/randomForest_2")
...
#--------------------------------------------------------------------------------------------------------#
# Auto-ML creates various models (here: GBM, GLM and deep learning) and combines them to a Stacked Ensemble
...
h2o.saveModel(auto_ml, path = "models/saved_models/auto_ml")
h2o.saveModel(auto_ml2, path = "models/saved_models/auto_ml_best_of_family")

h2o.removeAll(retained_elements = c(test, valid, train, data.h2o))


name_rf1 = list.files("models/saved_models/randomForest_1")
name_rf2 = list.files("models/saved_models/randomForest_2")
name_gbm1 = list.files("models/saved_models/GBM_1")
name_gbm2 = list.files("models/saved_models/GBM_2")
name_ml_bof = list.files("models/saved_models/auto_ml_best_of_family")
name_ml = list.files("models/saved_models/auto_ml")

rf_1 = h2o.loadModel(paste0("models/saved_models/randomForest_1/", name_rf1))
rf_2 = h2o.loadModel(paste0("models/saved_models/randomForest_2/", name_rf2))
gbm_1 = h2o.loadModel(paste0("models/saved_models/GBM_1/", name_gbm1))
gbm_2 = h2o.loadModel(paste0("models/saved_models/GBM_2/", name_gbm2))
auto_ml_bof = h2o.loadModel(paste0("models/saved_models/auto_ml_best_of_family/", name_ml_bof))
auto_ml = h2o.loadModel(paste0("models/saved_models/auto_ml/", name_ml))
