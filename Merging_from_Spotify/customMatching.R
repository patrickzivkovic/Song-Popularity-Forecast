...
original_df <- fread("original_dataset.csv")
...
complete_spotify <- fread("Datenverlust/all_tracks_from_spotify.csv")
...
artist_ids <- fread("artist_ids.csv")
...
fwrite(final, "perfectly_matched_dataset.csv")
