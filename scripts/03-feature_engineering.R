...
#insert key here
access_token <- get_spotify_access_token() #Spotify token 

#--------------------------------------- Prepare the data --------------------------------------#

lyrics <- fread("data/perfectly_matched_dataset.csv")
...
#fwrite(lyrics, "data/lyrics.csv")

########################## Adding Genre and Popularity of the Artist #####################################

#lyrics <- fread("data/lyrics_with_artist_id.csv")
...
fwrite(lyrics, "data/lyrics_final_corrected.csv")

################################################################################################
# Further Preprocessing

old <- fread("data/original_dataset.csv")
colnames(old)
colnames(lyrics)
...
fwrite(lyrics_done, "data/perfectly_matched_complete_dataset.csv")
